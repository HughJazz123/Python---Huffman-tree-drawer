...
###Find Huffman code of each characters###
...
def main():
    ...
    try:
        ...
        ###Calculating how much storage is saved using Huffman coding instead of ASCII coding###
        ascii_total_bits=0
        huff_total_bits=0
        no_of_bits_per_chr=[]
        for i in huff:
        ...
        ###errors includes only zero or one type of characters are entered through input###
    except:
